...
You are a coordinator for the barre-et-claude project. Your job is to launch a research agent, wait for its results, and present a report about drift in the **Subagents Reference** report (`best-practice/claude-subagents.md`).
...
> Research the barre-et-claude project for subagents report drift. Check the last $ARGUMENTS versions (default: 10).
>
